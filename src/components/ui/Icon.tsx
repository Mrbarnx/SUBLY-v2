...
export type IconName = 'alert-triangle'|'arrow-left'|'arrow-right'|'bank'|'box'|'briefcase'|'cart'|'check'|'chevron-down'|'circle-check'|'circle-x'|'clock'|'code'|'copy'|'credit-card'|'eye'|'eye-off'|'file-check'|'filter'|'graduation-cap'|'grid'|'headphones'|'home'|'info'|'lock'|'log-out'|'mail'|'megaphone'|'menu'|'message-circle'|'minus'|'package'|'palette'|'plus'|'search'|'settings'|'shield-check'|'sparkles'|'star'|'tag'|'trash'|'truck'|'user'|'users'|'wallet'|'x'|'zap'
...
const paths: Record<IconName, ReactNode> = {
  ...
  'log-out': <><path d="M10 17l5-5-5-5m5 5H3"/><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/></>,
  ...
  users: <><circle cx="9" cy="8" r="4"/><path d="M2 21a7 7 0 0 1 14 0M16 5a4 4 0 0 1 0 7m2 3a6 6 0 0 1 4 6"/></>,
